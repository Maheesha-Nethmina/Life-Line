        ...
        <div class="pt-2 col-md-6" id="details">
            ...
            <form class="g-4" id="req-form" method="POST" action="../New_Admin_Pannel/Add_volenteer.php" enctype="multipart/form-data">
                ...
                if (!empty($volunteerForm->getErrorMessage())) {
                    echo "
                     <div class='alert alert-warning alert-dismissible fade show' role='alert'>
                         <strong>{$volunteerForm->getErrorMessage()}</strong> 
                ...
                <div class=" col-12 entryarea">
                    ...
                    <input type="text" class="form-control" id="name-vol" name="name" required>
                    <div class="labelline">Your Name</div>
                </div>

                <div class="col-12 entryarea">

                    <input type="text" class="form-control" id="Address-vol" name="address" required>
                    <div class="labelline">Your Address</div>
                </div>
                <div class="row">
                    <div class="col-md-4 entryarea">
                        <input type="text" class="form-control" id="age-vol" name="age" required>
                        <div class="labelline">Your Age</div>
                    </div>
                    <div class="col-md-7 entryarea">
                        <input type="text" class="form-control" id="nic-vol" name="nic" required>
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 entryarea">
                        ...
                        <input type="text" class="form-control" id="contact-vol" name="phone" required>
                    ...
                    <div class="col-md-6 entryarea">
                        ...
                        <input type="text" class="form-control" id="email-vol" name="email" required>
                ...
                <div class="col-md-6" style="margin-bottom: 30px;">
                    ...
                    <select style="height: 40px; color: gray;" id="inputState" class="form-select" name="district" required>
                ...
                <div class="col-12 entryarea">
                    ...
                    <input type="text" class="form-control" id="days" name="image">
                ...
                <div class="col-12 entryarea">
                    ...
                    <input type="file" class="form-control" id="a/l" name="result" value="">
                </div>

                <div class="col-12 entryarea">
                    <p class="text-muted"> Add the Police Report of yours</p>
                    <input type="file" class="form-control" id="police_rep" name="policeimage" required>
                </div>
                <br>
                <br>
                ...
                <div class="col-12 entryarea">
                    ...
                    <textarea class="form-control" id="pre-vol" style="height: 100px;" name="pre" required></textarea>
