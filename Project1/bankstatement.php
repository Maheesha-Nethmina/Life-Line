    ...
    <body>
                            ...
                            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                                ...
                                <li class="menu-item">
                                    ...
                                    if (isset($_SESSION["username"])) {
                                        echo '<li class="menu-item"><a href ="#">' . $_SESSION["username"] . '</a></li>'; /* yet delcare href to ditec the page */
        ...
        <div class="bank_statement">
            <div class="statement_caption container">
                ...
                <p>The Bank Statement section provides a detailed overview of all monetary transactions made within the 
                    donation system on a monthly basis. This feature ensures transparency by displaying both incoming 
                    donations and outgoing funds in an organized manner. Users can track the flow of money, monitor their 
