...
<head>
    ...
    <script type="text/javascript">
        ...
        function handleDonate(beneficiaryId) {
            if (validateForm()) {
                const amount = document.getElementById('amount').value; // Get donation amount from the form
                const message = document.getElementById('blessingmassage').value;
                const name = document.getElementById('donorName').value;
                buynow(beneficiaryId, amount, message, name); // Pass amount to buynow function
