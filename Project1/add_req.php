            ...
            <form class="row g-3 pb-5" method="POST" action="add_req_process.php" enctype="multipart/form-data">
                ...
                <div class="col-md-6 pb-3">
                    <select id="inputState" class="form-select" name="oparation_type" required>
                        <option selected>Select Pateint's Disease</option>
                ...
                <div class="col-md-6 pb-3">
                    <input type="text" class="form-control" id="Age" name="age" placeholder="Pateint's Age" required>
                </div>
                ...
                <h3 class="">Enter Gardian Details</h3>
                <div class="col-md-6 pb-3">
                    <input type="text" class="form-control" id="gardinatname" name="Guardianname" placeholder="Gardiant's Name" required>
                </div>
                <div class="col-md-6 pb-3">
                    <input type="text" class="form-control" id="contact" name="phone" placeholder="Gardiant's Contact Number" required>
                </div>
