...
<body style="background-color: #e9f5ed">
    ...
    <div class="container1">
        ...
        class BenificiaryDetails
        {
            ...
            {
                try {
                    // Query to get data from the beneficiary and selectedbeneficiary tables
                    $query = "SELECT 
                    ...
                    // Fetch all beneficiaries as an associative array
            ...
            private function makeCards($benificiary)
            {
                ...
                if (!empty($benificiary['image'])) {
                    $imageData = base64_encode($benificiary['image']); // Binary data to Base64
                    $imageSrc = 'data:image/jpeg;base64,' . $imageData; // Assuming the image is a JPEG, adjust the MIME type as necessary
                } else {
