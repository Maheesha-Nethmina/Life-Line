                            ...
                            <li class="menu-item">
                                ...
                                if (isset($_SESSION["username"])) {
                                    ...
                                    if ($result) {
                                        ...
                                        if ($userType == 'Admin') {
                                            echo '<li class="menu-item"><a href ="/New_Admin_Pannel/Admin_conrol.php"> <img src="images/profile_Admin.png" id="logout"><a/></li>';
                                        }
                                    }
                                    if ($result) {
                                        $userType = $result['userType'];
                                        if ($userType == 'Volunteer') {
                                            echo '<li class="menu-item"><a href ="/Volunteer_pannel/volunteerDashboard.php"> <img src="images/profile_Admin.png" id="logout"><a/></li>';
                                        }
                                    }
                                }
                                ?>
                ...
                <div class="carousel-item active " id="coveritem">
                    ...
                    <div class="carousel-caption ">
                        ...
                        <div clsss="enter">
                            <?php
                            if (!isset($_SESSION['username'])) {
                                echo '<a href="login_User.php"><button type="button" class="apply">Log In</button></a>';
                    ...
                    <div class="col">
                        <div class="card " id="whyus-card">
                            <div class="card-body">
                                ...
                                <h5 class="whyus-card-title">Secure And Trustwarthy</h5>
