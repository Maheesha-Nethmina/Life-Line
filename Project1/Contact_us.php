        ...
        <div class="serviceicon">
            <div class="">
                <div class="row justify-content-center">
                    <div class="col-4 col-md-3 col-sm-2  width-50">
                        <div class=" text-center " id="c1">
                            <div class="icon">
                                <img alt="image" class="img-responsive" src="images/email.png">
                                <p class="content1">Just send us your questions<br>or concerns by straing a new<br>case and We will give<br>you the help you need.</p>
                            </div>
                    ...
                    <div class="col-4 col-md-3 col-sm-2  width-50">
                        <div class=" text-center " id="c2">
                            <div class="icon">
                                <img alt="image" class="img" src="images/callcenter.png">
                                <p class="content1">Question about this donation<br>system can be resolved using<br>all of our phone numbers<br> &nbsp;&nbsp;+94 768663035<br>&nbsp;&nbsp;+94 776626075</p>
                            </div>
                    ...
                    <div class="col-4 col-md-3 col-sm-2 width-50">
                        <div class=" text-center" id="c3">
                            <div class="icon">
                                <img alt="image" class="img" src="images/socialmedia.png">
                                <p class="content1">You can resolve all issues<br>regarding this donation system by<br>contacting us on all our<br>social media platforms. </p>
                            </div>
    ...
    <section class="contact-section">
        <div class="container">
            ...
            <form class="row g-4" id="contact-form" method="POST" action="ContactUsProcess.php">
                ...
                <div class="form-floating col-md-8">
                    <button type="submit" class="button" name="submit">Send Massage</button>
                </div>
                <div class="form-floating col-md-8">
                    <?php
                    if (isset($_GET['s'])) {
